...
const pintarCarrito = () => {
    ...
    productoCarrito.forEach(item => {
        ...
        clone.querySelector(".btnSumar").dataset.id = item.id;
        clone.querySelector(".btnQuitar").dataset.id = item.id;
        // console.log(item);
...
const sumarProducto = (e) => {
    ...
    // console.log("sumarProducto ", e.target.id);
...
const quitarProducto = (e) => {
    ...
    productoCarrito = productoCarrito.filter(item => {
